def binarySearch(lst, searchValue):
    ...
    Return Value: Index of the matched element, if searchValue is found, None otherwise
...
def main():
    '''
    Objective: To search for an element in the sorted list provided as an input by the user
